...
// function RandomCard() {
//     let randomcard = blackjackgame['card'][Math.floor(Math.random()*blackjackgame['cards'].length)];
//     return randomcard
// }
...
//         let allimages = document.querySelector('.flex-backjack-row-1').querySelector('img')
...
//         document.querySelector('#scoore-dealer').style.color = 'white';

//         document.querySelector('#blackjack-result').textContent = 'Lets Play Again';
